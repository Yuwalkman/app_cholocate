...
def main(page: ft.Page):
    ...
    label_sour= ft.Text("Sour:  0")
    label_bitter= ft.Text("Bitter:  0")
    label_dry= ft.Text("Dry:  0")
    
    def check_info(e):
        ...

    def slider_changed(e, type_name):
        type_name.value = f"{e.control.data}:{e.control.value}"
        page.update()
            ...
            page.views.append(
                ft.View(
                    ...
                    [   bakingdeatil.time_info, bakingdeatil.tempeature_info,bakingdeatil.note_info,
                        ...
                        label_sour,
                        ft.Slider(min=0, max=5, divisions=5, label="{value}",  on_change=lambda e: slider_changed(e,label_sour)),
                        label_bitter,
                        ft.Slider(min=0, max=5, divisions=5, label="{value}",  on_change=lambda e: slider_changed(e,label_bitter)),
                        label_dry,
                        ft.Slider(min=0, max=5, divisions=5, label="{value}",  on_change=lambda e: slider_changed(e,label_dry)),
